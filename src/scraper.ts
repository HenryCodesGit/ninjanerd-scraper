...
const SUBJECT_START: number = process.env.SUBJECT_START ? parseInt(process.env.SUBJECT_START) : 0
const CATEGORY_START: number = process.env.CATEGORY_START ? parseInt(process.env.CATEGORY_START) : 0
const LECTURE_START: number = process.env.LECTURE_START ? parseInt(process.env.LECTURE_START) : 0
